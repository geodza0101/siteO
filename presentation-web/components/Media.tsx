...
const mediaMentions: MediaMention[] = [
    {
        brand: "ТНТ / Foresight",
        title: "Шоу Foresight с Сергеем Светлаковым",
        link: "https://rutube.ru/play/embed/3d85d3a3770ae8c011685e432bb8de98?p=GtldX8qXIlQHveYquxQVoA",
        type: "TV Show",
        isVideo: true,
        summary: "Выступление на федеральном канале. Презентация AI-технологий и будущего профессий.",
        metrics: ["ТНТ", "Шоу Foresight", "Сергей Светлаков"]
    },
    {
        brand: "БРИКС+ Форум",
        title: "Спикер: AI в бизнес-процессах",
        link: "https://rutube.ru/play/embed/0abab0fdceaac5374bdb785f80cd131f/",
        type: "Speaker",
        isVideo: true,
        summary: "Доклад о внедрении искусственного интеллекта в реальный сектор экономики на международном форуме.",
        metrics: ["БРИКС+", "Спикер", "AI в бизнесе"]
    },
    {
        brand: "Skillbox Media",
        title: "«Я прошёл мясорубку»: рост до директора по маркетингу",
        link: "https://skillbox.ru/media/marketing/story-georgiy-djachvadze-2/",
        type: "Interview",
        role: "CMO",
        summary: "История карьерного роста от новичка до управления маркетингом. Как выжить и вырасти в агрессивной среде.",
        metrics: ["Рост до CMO", "Маркетинг", "Карьера"]
    },
    {
        brand: "Skillbox / Course",
        title: "Автор курса по маркетингу и AI",
        link: "https://skillbox.ru/course/marketing-network/",
        type: "Education",
        role: "Author",
        summary: "Партнерство со Skillbox. Обучил 100+ предпринимателей использованию нейросетей в бизнесе.",
        metrics: ["Автор курса", "100+ студентов", "AI Education"]
    },
    {
        brand: "Skillbox Success",
        title: "«11 дипломов»: история непрерывного обучения",
        link: "https://skillbox.ru/media/marketing/story-georgiy-djachvadze/",
        type: "Article",
        role: "Expert",
        summary: "Путь постоянного развития. Как академические знания превращаются в практические навыки вайб-кодинга.",
        metrics: ["Lifelong Learning", "11 дипломов", "Expertise"]
    }
];
